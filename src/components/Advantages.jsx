...
const Advantages = ({ emp, setEmp }) => {
  ...
  const slide = [
    {
      topic: "Хувийн зан төлөвийн давуу тал",
      value: emp.behaviorAdvantage,
      placeholder:
        "Үнэнч шударга, хөдөлмөрч, нөхөрсөг, хорт зуршилгүй, нийтэч гэх мэт... ",
      key: "behaviorAdvantage",
    },
    {
      topic: "Ажил карьерын давуу тал",
      value: emp.expAdvantage,
      placeholder:
        "Тоног төхөөрөмжтэй харьцах чадвартай, аюулгүй ажиллагаахы сургалтад хамрагдаж байсан, гагнуурын 2-р зэрэгтэй гэх мэт...",
      key: "expAdvantage",
    },
    {
      topic: "Урлаг спортын давуу тал",
      value: emp.sportAdvantage,
      placeholder: "Сагс тоглодог, волейбол 2-р зэрэгтэй...",
      key: "sportAdvantage",
    },
  ];
